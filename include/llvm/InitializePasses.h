...
void initializeConstructIdempotentRegionsPass(PassRegistry&);
void initializeMachineCopyPropagationPass(PassRegistry&);
void initializeMachineIdempotentRegionsPass(PassRegistry&);
void initializePatchMachineIdempotentRegionsPass(PassRegistry&);
void initializeDivideMachineIdempotentRegionsPass(PassRegistry&);
...
void initializeIdempotenceShadowIntervalsPass(PassRegistry&);
...
void initializeMemoryIdempotenceAnalysisPass(PassRegistry&);
